...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
            ...
            echo "<script>alert('Data Buku Berhasil Disimpan ke Database.') ; window.location = 'buku.php' </script>";
		...
		echo "<script>alert('Jenis file gambar yang anda kirim salah. File gambar harus berupa .jpg ; .gif ;.png'); window.location = 'input-buku.php' </script>";
   }
} else {
