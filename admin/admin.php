...
<?php } ?>
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <form action="admin.php" method="POST">
                                        <div class="input-group">
                                        <input type='text' class="form-control input-sm pull-right" style="width: 300px;"  name='qcari' placeholder='Cari berdasarkan User ID atau Username Pengguna' required /> 
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy <a href="#" target="_blank">SiPusWeb SMA PGRI 56</a> 2020
                </div>
            </aside><!-- /.right-side -->
