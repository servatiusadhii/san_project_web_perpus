...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	{			
		...
		echo "<script>alert('Jenis file gambar yang anda kirim salah. File gambar harus berupa .jpg ; .gif ;.png'); window.location = 'buku.php' </script>";
   }
} else {
	echo "<script>alert('Anda belum memilih gambar.') ; window.location = 'buku.php'</script>";
}
