...
<head>
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
        <!--[if lt IE 9]>
          ...
          <script src="https://oss.maxcdn.com/libs/respond.js/1.3.0/respo
          nd.min.js"></script>
          <![endif]-->
...
<?php } ?>
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <form action="buku.php" method="POST">
                                        <div class="input-group">
                                        <input type='text' class="form-control input-sm pull-right" style="width: 300px;"  name='qcari' placeholder='Cari berdasarkan Judul Buku' required /> 
              ...
              ?>
                ...
                <div class="text-right" style="margin-top: 10px;">
                 <a href="buku2.php" class="btn btn-sm btn-info">Refresh Buku <i class="fa fa-refresh"></i></a> 
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy <a href="#">SiPusWeb SMA PGRI 56 Ciputat</a> 2020
                </div>
            </aside><!-- /.right-side -->
