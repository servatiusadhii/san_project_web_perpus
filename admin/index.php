                    ...
                    <aside class="left-side sidebar-offcanvas">
                        ...
                        <section class="sidebar">
                            ...
                            <div class="user-panel">
								...
								<center><p style="color: white;">Administrator Perpustakaan</p></center>
								</div>
                            </div>
                            <!-- search form -->
                                            ...
                                            <header class="panel-heading">
                                                ...
                                                ?>
                                                    <div class="alert alert-success">
                                                        ...
                                                        <strong><?php echo $data3['fullname']; ?></strong>, Telah ditambahkan menjadi admin SiPusWeb SMA PGRI 56 yang baru. 
                                                    </div>
                                                <?php } ?>
                                                ...
                                                ?>
                                                    <div class="alert alert-info">
                                                        ...
                                                        <strong><?php echo $data4['judul']; ?></strong>, Buku bacaan baru yang ada di SiPusWeb SMA PGRI 56.
                                                    </div>
                                                <?php } ?>
                                                ...
                                                ?>   
                                                    <div class="alert alert-warning">
                                                        ...
                                                        <strong><?php echo $data5['nama']; ?> </strong> Pengunjung baru di SiPusWeb SMA PGRI 56.
                                                    </div>
                                                <?php } ?>
                                                </div>
                                        </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                          <section class="panel tasks-widget">
                              <header class="panel-heading">
                                Daftar Buku SiPusWeb SMA PGRI 56 Ciputat
                            </header>
                            <div class="panel-body">
                    ...
                    datasets: [
                        {
                            ...
                            data: [65, 59, 80, 81, 56, 55, 40, 30, 10, 90, 75, 25]
                        },
                        {
                            ...
                            data: [28, 48, 40, 19, 86, 27, 90, 80, 20, 89, 50, 86]
                        }
                    ]
                };
