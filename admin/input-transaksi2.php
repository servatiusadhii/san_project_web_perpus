...
<?php } ?>
                    ...
                    <aside class="left-side sidebar-offcanvas">
                        ...
                        <section class="sidebar">
                            ...
                            <div class="user-panel">
								...
								<center><p style="color: white;">Anggota Perpustakaan</p></center>
								</div>
                            </div>
                            <!-- search form -->
                ...
                <section class="content">
                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-transaksi2.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                ...
                                <?php
                                    ...
                                    echo '<option value='.$data['id'].'-'.$data['judul']. '-'.$data['jum_temp'].'>'.$data['judul'].' ( Tersedia: '.$data['jum_temp'].'pcs ) '.'</option>'; }
                                    ?>
                                  </select>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Catatan Tambahan</label>
                              <div class="col-sm-8">
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="index2.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
