...
$maks_hari_pinjam	= 3; //maksimal hari peminjaman
...
if ($id_trans==""||$judul=="") {
	...
	$uj=mysql_query("UPDATE data_buku SET jum_temp=(jum_temp+1) WHERE judul like '%$judul%'")or die ("Gagal update".mysql_error());
